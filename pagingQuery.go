...
// it returns AggregationData struct and  error if any error
// occurs during document query
func (paging *pagingQuery) Aggregate(filters ...interface{}) (paginatedData *AggregationData, err error) {
...
func (paging *pagingQuery) Find() (findData *FindData, err error) {
...
// AggregationData struct holds data and
// pagination detail
